/* CreditCardViewModel.cs
 * Purpose: View model for credit card information
 * 
 * Revision History:
...
{
    /// <summary>
    ///     View model for credit card information
    /// </summary>
    /// <remarks>
    ///     This class is abstract as it is never meant to be instantiated
    /// </remarks>
    public abstract class CreditCardViewModel
    {
        ...
        /// </summary>
        [StringLength(maximumLength: 19, ErrorMessageResourceName = nameof(ErrorMessages.StringLength),
        ...
        /// </summary>
        [StringLength(maximumLength: 4, ErrorMessageResourceName = nameof(ErrorMessages.StringLength),
            ErrorMessageResourceType = typeof (ErrorMessages))]
        ...
        /// </summary>
        [Required]
        [StringLength(maximumLength: 255, ErrorMessageResourceName = nameof(ErrorMessages.StringLength),
            ErrorMessageResourceType = typeof (ErrorMessages))]
        ...
        [StringLength(maximumLength: 10, ErrorMessageResourceName = nameof(ErrorMessages.StringLength),
            ErrorMessageResourceType = typeof (ErrorMessages))]
