/* BillingInfoViewModel.cs
 * Purpose: View model for the billing info step of checkout
 * 
 * Revision History:
...
{
    /// <summary>
    ///     View model for the billing info step of checkout
    /// </summary>
    /// <remarks>
    ///     No info is posted back using this view model
    /// </remarks>
    public class BillingInfoViewModel
    {
        ...
        public IEnumerable<SelectListItem> Years
            => new SelectList(Enumerable.Range(DateTime.Today.Year, 20));
